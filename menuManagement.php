    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["product_image"]["tmp_name"], $target_file)) {
            ...
            $insertQuery = "INSERT INTO menu (item_image_path, item_name, price)
                            VALUES ('$target_file', '$item_name', '$price')";
...
<head>
    ...
    <title>The Outer Clove Restaurant - Menu Management</title>
...
<body>
    <section>
        <header>
            ...
            <ul class="navlist">
                <li><a href="admin.php" class="active">Reservation Management</a></li>
                <li class="active"><a href="#">Menu Management</a></li>
